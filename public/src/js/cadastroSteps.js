 (function ($, undefined) {
  ...
  function renderPagination(wizard, options, state) {
    if (options.enablePagination) {
      var pagination =
        ...
        buttonTemplatePrevious = '<li><a href="#{0}" role="menuitem"><i class="fas fa-arrow-left"></i> {1}</a></li>',
        buttonTemplateNext = '<li><a href="#{0}" role="menuitem"><i class="fas fa-arrow-right"></i> {1}</a></li>',
        buttonTemplateFinish = '<li><a href="#{0}" role="menuitem"><i class="fas fa-check"></i> {1}</a></li>',
        buttonTemplateCancel = '<li><a href="#{0}" role="menuitem"><i class="fas fa-times"></i> {1}</a></li>',
        buttons = "";
  
      if (!options.forceMoveForward) {
        buttons += buttonTemplatePrevious.format("previous", options.labels.previous);
      }
      buttons += buttonTemplateNext.format("next", options.labels.next);
      if (options.enableFinishButton) {
        buttons += buttonTemplateFinish.format("finish", options.labels.finish);
      }
      if (options.enableCancelButton) {
        buttons += buttonTemplateCancel.format("cancel", options.labels.cancel);
      }
  ...
  var contentMode = ($.fn.steps.contentMode = { html: 0, iframe: 1, async: 2 });
