...
$(document).ready(function () { 
    ...
    function validacaoInicial(){
        fomulario = localStorage.getItem('prime-form');
        fomulario = JSON.parse(fomulario);
        if (!fomulario){ window.location.href = '/cotacao'; return; }
        ...
        orcamento.tipo = orcamento.produto;
